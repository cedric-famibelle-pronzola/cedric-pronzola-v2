      ...
      return {
        ...
        metadata: {
          ...
          author: {
            ...
            url: data.author?.url || 'https://cedric-pronzola.dev'
          },
          slug: slug
        }
      };
    ...
    <>
        ...
        <div className="py-16 bg-background">
          <div className="container mx-auto px-4">
            ...
            <article className="prose prose-lg dark:prose-invert mx-auto">
              ...
              <ShareButtons
                url={`https://cedric-pronzola.dev/${locale}/blog/${slug}`}
                title={article.metadata.title}
              />
      ...
      <JsonLd
        data={{
          ...
          'url': `https://cedric-pronzola.dev/blog/${slug}`,
          '@id': `https://cedric-pronzola.dev/blog/${slug}`,
          'mainEntityOfPage': {
            '@type': 'WebPage',
            '@id': `https://cedric-pronzola.dev/blog/${slug}`
          }
